...
$$ \implies \Delta t_A = \frac{L_{A}}{2(c - v)} - \frac{L_{A}}{2(c + v)} \quad \text{or} \quad \Delta t_A = \frac{2vL_{A}}{2(c^{2} - v^{2})}$$

$$ \implies \Delta t_A = \frac{vL_{A}}{c^{2}(1 - \frac{v^{2}}{c^{2}})} \quad \text{,where} \quad \frac{1}{(1 - \frac{v^{2}}{c^{2}})} \quad \text{is just} \quad \gamma^{2}$$

...
So finally, what was the result of this experiment? No time difference was found. The velocity of earth through the aether could not be detected. Null result. This was very puzzling and disturbing so much so that it haunted Michelson for the rest of his life.